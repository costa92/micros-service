...
// UnimplementedOrderServerServer must be embedded to have
...
func (UnimplementedOrderServerServer) testEmbeddedByValue()                     {}
...
func RegisterOrderServerServer(s grpc.ServiceRegistrar, srv OrderServerServer) {
	// If the following call pancis, it indicates UnimplementedOrderServerServer was
...
var OrderServer_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "orderserver/v1/order-server.proto",
}
