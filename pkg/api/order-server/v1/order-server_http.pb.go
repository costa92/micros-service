...
func RegisterOrderServerHTTPServer(s *http.Server, srv OrderServerHTTPServer) {
	...
	r.GET("/v1/order/{order_id}", _OrderServer_Detail1_HTTP_Handler(srv))
}
...
func _OrderServer_Detail1_HTTP_Handler(srv OrderServerHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
