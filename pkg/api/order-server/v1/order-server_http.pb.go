...
func RegisterOrderServiceHTTPServer(s *http.Server, srv OrderServiceHTTPServer) {
	...
	r.GET("/v1/order/{order_id}", _OrderService_Detail1_HTTP_Handler(srv))
}
...
func _OrderService_Detail1_HTTP_Handler(srv OrderServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
